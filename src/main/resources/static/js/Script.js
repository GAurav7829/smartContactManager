...
//will use ajax to send request to server to create order
	$.ajax({
...
const updatePaymentOnServer=(payment_id,order_id,status)=>{
	$.ajax({
		...
		error:function(error){
			console.log("Something went Wrong...");
			swal("Good job!", "Your Payment Successfull, but we didnot capture it, will contact you asap", "error");
		}
	});
}